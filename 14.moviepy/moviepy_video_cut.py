...
class login(QWidget):
    ...
    def initUI(self):
        ...
        self.sourceLabel.setText("Technical support:火火 ")
    ...
    def select_source(self):
        target,fileType = QFileDialog.getOpenFileName(self, "select the source file", __file__)
        self.source_le.setText(str(target))
    #保存的视频文件名称，要写上后缀名
    def select_target(self):
        target,fileType = QFileDialog.getSaveFileName(self, "select the save file", __file__)
